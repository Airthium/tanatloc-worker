 ...
 * @returns Elements
 */
std::vector<TopoDS_Shape> getElements(TopoDS_Shape shape,
...
getElements(TopoDS_Shape shape, Handle(TDocStd_Document) document,
  ...
  while (explorer.More()) {
    ...
    Standard_Boolean res =
        colorTool->GetColor(element, XCAFDoc_ColorSurf, internalColor);
 ...
 */
std::vector<TopoDS_Shape>
getSolids(TopoDS_Shape shape, Handle(TDocStd_Document) document,
          std::vector<std::pair<bool, Quantity_Color>> *color) {
 ...
 */
std::vector<TopoDS_Shape>
getFaces(TopoDS_Shape shape, Handle(TDocStd_Document) document,
         std::vector<std::pair<bool, Quantity_Color>> *color) {
 ...
 */
std::vector<TopoDS_Shape>
getEdges(TopoDS_Shape shape, Handle(TDocStd_Document) document,
         std::vector<std::pair<bool, Quantity_Color>> *color) {
